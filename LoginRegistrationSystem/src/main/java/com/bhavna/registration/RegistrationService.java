...
import com.bhavna.appuser.AppUser;
import com.bhavna.appuser.AppUserRole;
import com.bhavna.appuser.AppUserService;
import com.bhavna.email.EmailSender;
...
public class RegistrationService {
	...
	public String register(RegistrationRequest request) {
		...
		String token = appUserService.signUpUser(new AppUser(request.getUserName(), request.getPassword(),
				request.getPhone(), request.getEmail(), request.getSex(), request.getAge(), AppUserRole.USER));
